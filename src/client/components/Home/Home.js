            ...
            <div>
                <div className="content-section implementation button-demo">
                    <Menu model={[
                        {
                            label: 'Search',
                            items: [{ label: 'Users', icon: 'pi pi-fw pi-user', command: () => { window.location.hash = "/fileupload"; } },
                            { label: 'Restaurants', icon: 'pi pi-fw pi-home', url: 'http://primetek.com.tr' }]
                        },
                        {
                            label: 'Profile',
                            items: [{ label: 'Edit User', icon: 'pi pi-fw pi-cog', command: () => { window.location.hash = "/"; } },
