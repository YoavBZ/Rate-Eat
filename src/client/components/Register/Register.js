    ...
    render() {
        return (
            <div>
                ...
                <InputText placeholder="Location" onChange={(e) => this.props.changeFieldHandler("locatoin", e.target.value)} type="text" />
                <InputText placeholder="Picture" onChange={(e) => this.props.changeFieldHandler("picture", e.target.value)} type="text" />
                {/* <FileUpload /> */}
                <Button variant="primary" onClick={() => this.props.registerHandler(this.props.username, this.props.password, this.props.location, this.props.picture)} type="submit" label="Submit" />
            </div>
        );
    }
