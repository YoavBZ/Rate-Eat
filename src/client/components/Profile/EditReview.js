                ...
                <div className="p-col-12 p-md-8 review-details" style={{textAlign: 'left', margin: 'auto'}}>
                    <div className="p-grid" style={{position: 'relative', left: '-100%'}}>
                        <div className="p-col-2 p-sm-6">Bathroom Quality:</div>
                            <Rating className="p-col-2 p-sm-6" cancel={false} value={this.props.review.bathroomQuality} disabled={!this.props.editReview}/>
                        <div className="p-col-2 p-sm-6">Staff Kindness:</div>
                            <Rating className="p-col-2 p-sm-6" cancel={false} value={this.props.review.staffKindness} disabled={!this.props.editReview}/>
                        <div className="p-col-2 p-sm-6">Cleanliness:</div>
                            <Rating className="p-col-2 p-sm-6" cancel={false} value={this.props.review.cleanliness} disabled={!this.props.editReview}/>
                        <div className="p-col-2 p-sm-6">Drive Thru Quality:</div>
                            <Rating className="p-col-2 p-sm-6" cancel={false} value={this.props.review.driveThruQuality} disabled={!this.props.editReview}/>
                        <div className="p-col-2 p-sm-6">Delivery Speed:</div>
                            <Rating className="p-col-2 p-sm-6" cancel={false} value={this.props.review.deliverySpeed} disabled={!this.props.editReview}/>
                        <div className="p-col-2 p-sm-6">Food Quality:</div>
                            <Rating className="p-col-2 p-sm-6" cancel={false} value={this.props.review.foodQuality} disabled={!this.props.editReview}/>
                    </div>
                </div>
